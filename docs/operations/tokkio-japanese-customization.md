...
RAG を有効化している場合は、controller を同期または再起動する前に host-side NVIDIA RAG Blueprint を起動し、`http://127.0.0.1:8081/v1/health?check_dependencies=true` が通ることを確認してください。RAG の起動と文書取り込みは [`infra/rag/README.md`](/home/kyano/workspace/ACE/ace_kagawa/infra/rag/README.md) を参照してください。
